  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-[#eef2ff] via-[#f9e7ff] to-[#dbeafe] overflow-hidden relative">
      ...
      <nav className="w-full flex items-center justify-between px-6 md:px-14 py-6 relative z-10">
        ...
        {/* Desktop Nav */}
        <div className="hidden md:flex items-center gap-10 text-[#312e81] font-medium">
      ...
      <div className="w-full flex flex-col lg:flex-row items-center justify-center gap-16 px-6 md:px-12 pt-44 pb-10 relative z-10">
        ...
        <div className="max-w-lg text-center lg:text-left">
          ...
          <p className="mt-6 text-gray-600 text-lg leading-8">
            Login to continue your shopping journey with OneeCart.
          </p>
        ...
        <div className="w-full max-w-xl bg-white/40 backdrop-blur-2xl border border-white/30 rounded-[40px] shadow-2xl p-8 md:p-12">
          ...
          {/* Google Button */}
          <button className="w-full h-16 bg-white rounded-2xl shadow-lg hover:shadow-xl transition duration-300 mt-10 flex items-center justify-center gap-4" onClick={googleLogin}>
                      <img
                        src={google}
                        alt="google"
                        className="w-7 h-7"
         ...
         <form onSubmit={handleLogin} className="space-y-5">
            ...
            {/* Email */}
            <div className="w-full h-16 bg-white/70 rounded-2xl shadow-md flex items-center px-5 cursor-pointer" >
